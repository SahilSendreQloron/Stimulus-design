...
function MySkills() {
  return (
    <div className='myskills-parent w-[100%] h-[56rem] sm:h-[35rem] md:h-[40rem] lg:h-[25rem] xl:h-[23rem]  grid lg:grid-cols-2 grid-cols-1'>
        <div className='lg:w-[100%] h-[30%] lg:h-[100%] p-7 order-2 sm:order-1'>
        ...
        <div className='mb-0 h-[70%] md:h-[100%] lg:h-[100%] w-[100%] grid grid-col-1 sm:grid-cols-2 order-1 sm:order-2'>
